...
public class ActivityClient {
	...
	public Activity get(String id) {
		...
		// id).request(MediaType.APPLICATION_JSON).get(Activity.class);
		...
		// Note: we can request JSON, not XML by adding the string
		// MediaType.APPLICATION_JSON to the request() call above.
